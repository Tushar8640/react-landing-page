...
const FlashSaleCard = ({ product }) => {
  ...
  return (
    <>
      <div
        className={`max-w-[280] h-[508px] ${
          !over && "ring-[1px]"
        } ring-[#F2F2F2] bg-white text-gray-900  `}
        onMouseOver={() => setOver(true)}
        onMouseOut={() => setOver(false)}
      >
        <div className={`p-[15px] ${over && "ring-[1px]"} ring-[#F2F2F2]`}>
          <img
            src={image}
            alt=""
            className="object-contain object-center w-full rounded-md h-[131px] bg-white my-3 transform group-hover:-scale-x-100"
          />
          <div className="mt-10 mb-1 flex flex-col justify-between ">
            <span className="block text-[12px]  text-[#8B928F] mb-3">
              {category}
            </span>
        ...
        <div className={`${!over ? "visible" : "hidden"} my-1 p-2 h-[80px`}>
        ...
        <div
          className={`${
            over ? "visible" : "hidden"
          } flex justify-around my-1 p-2 h-[80px] items-center`}
        >
        ...
        <div className={`p-[10px] ${over && "ring-[1px] h-[100px]"} ring-[#F2F2F2]`}>
